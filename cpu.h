...
#define ST   0x26 /* Writes to referenced location in data memory. (address 256 - 2047). */
#define LD   0x27 /* Reads from referenced location in data memory (address 256 - 2047). */
...
#define Y YL     /* Alias for using Y register as pointer. */
